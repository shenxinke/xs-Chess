...
cc.game.onStart = function () {
   ...
   // cc.view.setDesignResolutionSize(80, 80, cc.ResolutionPolicy.SHOW_ALL);


    //
    // cc.webglContext.preserveDrawingBuffer=true;
...
//      cc.director.runScene(new HelloWorldScene());
    ...
    //
    //     // GMessagePort.setCallBack(fromIndex);
    //    fromIndex();
    //    // console.log("222222222222222333333333333333333333");
    //   //   CallBack();
    // });
