...
import com.xswq.chess.myapplication.utils.ColorUtil;
...
public class StringScrollPicker extends ScrollPickerView<CharSequence> {
    ...
    public StringScrollPicker(Context context, AttributeSet attrs,
        ...
        setData(new ArrayList<CharSequence>(Arrays.asList("one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "eleven", "twelve")));
