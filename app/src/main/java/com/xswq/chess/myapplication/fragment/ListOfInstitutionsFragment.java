...
public class ListOfInstitutionsFragment extends BaseFragment {
    private View mView;
    ...
    protected void initData() {
        ...
        listView = mView.findViewById(R.id.friends_list);
    ...
    private int getLayout() {
        return R.layout.fragment_institutions_list_layout;
    }

    private void getInstiutionsInfo() {
        try {
