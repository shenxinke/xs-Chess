...
public class GuideVideoFragment extends BaseFragment implements HttpCallBackLisener {
    ...
    public static GuideVideoFragment getInstances(String userId, String token) {

        GuideVideoFragment mGuideVideoFragment = new GuideVideoFragment();
    ...
    private void getRequstParamer() {
        GuideVideoApi mGuideVideoApi = new GuideVideoApi(this);
        mGuideVideoApi.setMethod(ContactUrl.JINIORVIDEO);
        mGuideVideoApi.setUid(userId);
        mGuideVideoApi.setToken(token);
        mGuideVideoApi.setJuniorVideoname("SFK");
        GuideVideoSub mGuideVideoSub = new GuideVideoSub(mGuideVideoApi);
