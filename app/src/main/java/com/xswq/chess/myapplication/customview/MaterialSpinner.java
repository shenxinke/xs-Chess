...
import com.xswq.chess.myapplication.adapter.MaterialSpinnerAdapter;
import com.xswq.chess.myapplication.adapter.MaterialSpinnerAdapterWrapper;
import com.xswq.chess.myapplication.adapter.MaterialSpinnerBaseAdapter;
import com.xswq.chess.myapplication.utils.SpinnerUtils;
...
public class MaterialSpinner extends android.support.v7.widget.AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        defaultPaddingBottom = defaultPaddingTop = resources.getDimensionPixelSize(R.dimen.dp_0);
        defaultPaddingLeft = defaultPaddingRight = resources.getDimensionPixelSize(R.dimen.dp_12);
        if (rtl) {
            defaultPaddingRight = resources.getDimensionPixelSize(R.dimen.dp_24);
        } else {
            defaultPaddingLeft = resources.getDimensionPixelSize(R.dimen.dp_24);
        }
        defaultPopupPaddingLeft =
                defaultPopupPaddingRight = resources.getDimensionPixelSize(R.dimen.dp_24);
        defaultPopupPaddingTop = defaultPopupPaddingBottom = resources.getDimensionPixelSize(R.dimen.dp_12);
        ...
        setBackgroundResource(R.drawable.textview_round_border);
        ...
        if (!hideArrow) {
            arrowDrawable = SpinnerUtils.getDrawable(context, R.drawable.ms__arrow).mutate();
...
//        drawables[2] = arrowDrawable;
                arrowDrawable.setBounds(0, 0, Util.dip2px(context, 15), Util.dip2px(context, 10));
...
//      setCompoundDrawablesWithIntrinsicBounds(drawables[0], drawables[1], drawables[2], drawables[3]);
    ...
    private int calculatePopupWindowHeight() {
        ...
        float itemHeight = getResources().getDimension(R.dimen.dp_48);
