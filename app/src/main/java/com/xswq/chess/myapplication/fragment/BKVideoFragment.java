...
public class BKVideoFragment extends BaseFragment implements HttpCallBackLisener {
    ...
    public static BKVideoFragment getInstances(String userId, String token) {

        BKVideoFragment mGuideVideoFragment = new BKVideoFragment();
    ...
    private void getRequstParamer() {
        ...
        mGuideVideoApi.setJuniorVideoname("BK");
