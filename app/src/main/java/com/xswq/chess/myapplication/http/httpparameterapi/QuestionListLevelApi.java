...
public class QuestionListLevelApi extends BaseApi {
    ...
    public QuestionListLevelApi(HttpCallBackLisener mHttpCallBackLisener){
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        Observable Observable = questionService.getLevelList(getQuestionType(),getToken(),getUid());
        return Observable;
    }
