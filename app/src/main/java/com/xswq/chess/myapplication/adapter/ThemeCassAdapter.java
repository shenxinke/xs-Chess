 ...
 * 备课列表适配器
 */
public class ThemeCassAdapter extends BaseAdapter {
    private Context context;
    private List<ThemeListBean.DataBean.ListBean> list;
    private String userId;
    private String touken;
    private int prepareLessinStage = 1;
    private int userType;

    public ThemeCassAdapter(Context context, List<ThemeListBean.DataBean.ListBean> themeList, String userId, String touken, int userType) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.theme_cass_item, null);
            comHolder = new ComViewHolder();
            comHolder.userName = convertView.findViewById(R.id.cass_name);
        ...
        comHolder.userName.setText(Util.signString(itemStr));
