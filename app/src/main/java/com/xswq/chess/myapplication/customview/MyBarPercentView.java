...
public class MyBarPercentView extends View {
    ...
    public static final int RADIUS = 20;     // 圆角矩形半径
    ...
    public MyBarPercentView(Context context, @Nullable AttributeSet attrs) {
        ...
        mHeight = typedArray.getDimensionPixelSize(R.styleable.BarPercentView_barHeight, context.getResources().getDimensionPixelSize(R.dimen.dp_20));
        ...
        radius = typedArray.getInt(R.styleable.BarPercentView_barRadius, Util.dip2px(context,RADIUS));
        init();
    }
